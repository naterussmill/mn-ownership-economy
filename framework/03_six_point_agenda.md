...
- State capital gains exemption on proceeds from sales to ESOPs, stacked on the federal §1042 exemption
- $5–10 million technical assistance fund administered through MNCEO, with per-conversion feasibility study grants
- Right of first refusal legislation modeled on Maine's 2023 law
- Explicit rural outreach mandate: at least 40% of technical assistance grants directed to businesses in greater Minnesota counties
- Worker retention study: commission DEED to document ESOP vs. non-ESOP turnover rates in Minnesota, building the evidentiary base for workforce development arguments
...
- MNCEO tracks conversion pipeline, feasibility studies, and conversions completed — this is their core mission and they already report annually
- Minnesota Department of Revenue tracks capital gains exemption utilization — cost and reach of the tax incentive
...
- *If* the capital gains exemption is being claimed primarily by larger businesses: refine eligibility criteria to prioritize businesses under 100 employees where the succession crisis is most acute and private equity competition most predatory
- *If* conversion rates remain flat despite incentives: the binding constraint may be successor financing (workers can't afford to buy), not seller incentives — shift resources toward Phase 2 Finance Authority subordinated debt
...
- Amend MnCIFA enabling statute to include business cooperative conversions, formation, agricultural cooperative development, childcare cooperative formation, and community-owned renewable energy projects as eligible project types
- Amend DEED's Minnesota Investment Fund to include worker-owned and cooperative businesses as eligible borrowers
- Establish a Minnesota Cooperative Loan Fund in Phase 2, initially capitalized at $25–50 million, with eligible uses including:
  - Business cooperative formation, conversion, and expansion
  - Agricultural cooperative formation and expansion
  - Community-owned renewable energy development
  - Childcare cooperative formation and startup
  - Technical assistance, governance training, and management development across all categories — not just feasibility studies but ongoing support through the first 3–5 years of operation
- Long-term: the Cooperative Loan Fund becomes a window of the Minnesota Public Bank, with permanent capital base independent of legislative appropriations
...
- MnCIFA and DEED report loan volume, borrower demographics, and geographic distribution under existing reporting requirements — mandate coverage of cooperative borrowers explicitly
- CoMinnesota and Cooperative Network track sector size and growth — formalize and fund this tracking function
...
- *If* cooperative survival rates underperform conventional businesses: capital access is not the binding constraint. Governance and management support are more important — invest in peer learning networks, cooperative management training programs, and experienced cooperative manager recruitment before expanding lending
- *If* the sector is growing but returns to members are weak: capital access is not the binding constraint; business model support may be more important
- *If* community energy cooperative formation is strong: elevate this as a distinct policy track and pursue dedicated clean energy cooperative funding in partnership with environmental coalition partners
...
- Amend state procurement statutes to establish a scoring preference — not a set-aside — for worker-owned and cooperative enterprises in competitive bids
- Direct the Department of Administration to develop a certification process for worker-owned and cooperative vendors, including tribally owned enterprises as an explicitly eligible category
- Require that at least 25% of certified vendor outreach be directed to greater Minnesota businesses, with annual geographic reporting
- Encourage Minneapolis, St. Paul, and other municipalities to adopt parallel policies independently — city-level action can move faster and demonstrate results that build state-level support
- Encourage public university systems and large nonprofit anchor institutions to voluntarily adopt parallel policies, building the Cleveland Model analog in the Twin Cities
...
- Department of Administration tracks vendor certification and contract awards — this is standard procurement reporting, extended to include ownership type
- Legislative Auditor conducts a 3-year program evaluation — standard practice for new procurement preferences
...
- *If* the preference is producing legal challenges: assess scope and adjust preference design toward scoring criteria rather than set-asides, which are more legally durable
- *If* contracted enterprises are not growing: the contract sizes are too small to matter — focus on higher-value contract categories
...
- State Board of Investment or designated program administrator tracks enrollment, balances, and investment performance — standard fiduciary reporting
- Minnesota Department of Revenue tracks demographic distribution of accounts and benefit levels
- Legislative Auditor conducts 5-year program evaluation on enrollment, administration, and early indicators
- Long-term outcome study: commission an independent longitudinal evaluation beginning at program year 10, tracking the first cohort through age 25
...
- *If* at year 12, account balances are insufficient to matter: increase initial deposits or add annual contributions — the north star is accounts large enough to be genuinely consequential at 18
...
- Minnesota State Board of Investment publishes proxy voting records — currently voluntary; this policy makes it mandatory and structured
- Pension board's beneficiary advisory council tracks voting compliance and alignment with guidelines
- Independent fiduciary audit at year 3 and year 7: does the voting policy comply with fiduciary duty? What is the relationship between governance engagement and portfolio performance?
- Academic partnership: University of Minnesota Carlson School or Humphrey School conducts ongoing research
...
- *If* portfolio performance deteriorates in correlation with governance engagement: pause and conduct independent review before expanding the program
- *If* beneficiary advisory council is not representative of the workforce: revise governance structure to ensure frontline worker voice, not just union leadership
...
- MHFA tracks CLT and housing cooperative loans under its existing portfolio reporting — extend to include permanent affordability stock as a tracked category
- ROC USA tracks MHP conversion pipeline and completions nationally — require Minnesota-specific reporting as a condition of state partnership funding
...
- *If* baby bond housing withdrawals are near zero (when first cohort matures): awareness is the problem — integrate housing cooperative and CLT options explicitly into baby bond outreach materials
