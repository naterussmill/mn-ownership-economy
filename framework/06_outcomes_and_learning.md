...
- Share of ESOP conversions in majority-BIPOC-workforce businesses
- Share of cooperative lending reaching rural counties and communities of color
- Demographic composition of the certified vendor pool under procurement preference
- Baby bond enrollment rates and account balances disaggregated by race and income
- Pension beneficiary advisory council composition relative to the public workforce
- CLT and housing cooperative demographic composition relative to the communities they serve
...
- Capital access: are Native CDFIs in Minnesota able to access public bank wholesale funding, and at what volume?
- Citizen enterprise: are tribal citizen-owned businesses accessing cooperative loan fund capital, and is the Native CDFI partnership model working?
- Procurement: are tribally owned enterprises participating in and winning contracts under the procurement preference program?
- Baby bonds: enrollment and account balance trends for Native children, tracked in partnership with tribal governments that choose to share data — not extracted without consent
...
- *ESOP technical assistance fund:* If fewer than 15 conversions are supported annually by year 3, and qualitative research shows the barrier is not capital but owner culture or employee interest, redirect resources to awareness and peer learning rather than continuing to fund an underutilized subsidy
- *Cooperative Loan Fund:* If default rates exceed 15% after year 5, the underwriting criteria are wrong — pause new lending, commission an independent review, and redesign before resuming. If defaults are concentrated among cooperatives that received capital without adequate governance support, the lesson is clear: pair every loan with technical assistance, or do not make the loan.
- *Procurement preference:* If the certified vendor pool remains below 100 vendors after year 3, the administrative burden of certification is too high — simplify the process or move to a self-certification model
- *Baby bonds:* If enrollment is below 50% of eligible children after auto-enrollment is implemented, something more fundamental is wrong — investigate whether distrust of government institutions is a barrier and consider community-based administration
- *Pension shareholder democracy:* If a court finds the voting policy violates fiduciary duty, pause immediately and engage fiduciary counsel before any further implementation
- *Permanently affordable housing:* If CLT and housing cooperative units are not reaching lower-income families — if permanent affordability is serving middle-income households that could access market-rate housing — redesign income eligibility criteria before expanding
