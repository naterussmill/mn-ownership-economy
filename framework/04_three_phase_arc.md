...
- Pass ESOP capital gains exemption and MNCEO technical assistance fund as a bundled succession bill
- Amend MnCIFA and DEED enabling statutes to include cooperative, ESOP, energy cooperative, and housing cooperative transitions as eligible uses
- Pursue procurement preference at Minneapolis, St. Paul, and anchor institution level
- Pass dedicated MHP cooperative conversion fund legislation
- Begin pension shareholder democracy legal review and pension board engagement
...
- Share of Minnesota GDP generated by worker-owned, cooperative, and mutual enterprises
- Share of Minnesota businesses that are employee-owned or cooperative, by county
- Minnesota racial wealth gap trend vs. national trend — is Minnesota outperforming?
- Public bank financial performance: net income, loan performance, leverage ratio
- Capital retained in Minnesota: are public deposits that previously left the state staying in-state?
